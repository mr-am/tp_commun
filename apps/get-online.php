...
<!-- On vérifie que l'utilisateur est inscrit dans la table des membres connectés. Si c'est le cas, alors on modifie sa date de dernière connexion pour qu'il ne soit pas ensuite supprimé. Dans le cas contraire, on ajoute l'utilisateur dans la base de données. -->
<?php
...
<!-- On supprime tous les membres dont la dernière date de connexion date de plus de cinq secondes. Si le membre n'a pas actualisé depuis cinq secondes, il n'est, soit plus sur le chat, soit buggé.  -->
<?php
...
<!-- On va afficher la liste des membres connectés. Le champ online_status va enfin servir. Il va nous permettre de définir le statut de l'utilisateur. -->
<?php
