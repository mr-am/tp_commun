...
<!-- Vérifie que le compte de l'utilisateur existe toujours. Si le compte a été supprimé, il faut que l'utilisateur ne puisse plus poster des messages. On redirigera ensuite l'utilisateur -->
<?php
...
<!-- Affichage de l'annonce par un appel a "chat_annonce", à l'aide des la librairie PDO. Ce sera situé en haut du chat -->
<?php
...
<!-- Afficher les derniers messages du chat par une liaison entred chat_messages et chat_accounts -->
<?php
